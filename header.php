...
<head>
    ...
    <body>
            ...
            <div class="offcanvas__info">
                <div class="offcanvas__wrapper">
                    <div class="offcanvas__content">
                        ...
                        Marudham Logistics, based in Coimbatore, is your trusted partner for Packers and Movers services in India and internationally. 
                        </p>
                            ...
                            <ul>
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a target="_blank" href="#">Shop Site No:1, Balavasantha Complex, Thendral Nagar 80 feet Road, Near Sai Krishna Mahal, Police Quaters, Ganapathy, Coimbatore - 641006.</a>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a href="mailto:info@azent.com"><span class="mailto:marudhamlogistics@gmail.com">marudhamlogistics@gmail.com</span></a>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center">
                                    <div class="offcanvas__contact-icon mr-15">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a target="_blank" href="#">Mod-Sat, 09am -06pm</a>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center">
                                    <div class="offcanvas__contact-icon mr-15">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a href="tel:+918122517891">+91 81225 17891</a>
                                    </div>
                                </li>
                            </ul>
        ...
        <header>
            <div class="header-2 header-3" id="header-sticky">
                        ...
                        <div class="col-lg-4">
                            <div class="header-right d-flex justify-content-end">
                                <div class="header-icon d-flex">
                                    ...
                                    <button class="offcanvas-bar sidebar__toggle"><i class="fa-sharp fa-regular fa-bars"></i></button>
                                </div>
